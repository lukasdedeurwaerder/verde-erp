-- ============================================================
-- Het logboek slaat voortaan over wat de testscripts doen: tijdelijke
-- testbedrijven en testaccounts. Hun regels verdwijnen al met het
-- testbedrijf, maar het aanmaken van het bedrijf zelf en van een
-- tijdelijk docentenaccount bleef als ruis staan.
-- ============================================================
...
delete from logboek
where (details ->> 'tabel' = 'bedrijven' and onderwerp like 'Bedrijf TEST % (wordt verwijderd)')
   or (details ->> 'tabel' = 'profielen' and onderwerp in ('Account Testdocent') and gebruiker_id is null);
